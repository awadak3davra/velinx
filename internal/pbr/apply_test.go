...
func TestApply(t *testing.T) {
	...
	if !strings.Contains(r.Stdin[0], "198.51.100.0/24") || !strings.Contains(r.Stdin[0], "delete table inet wakeroute_pbr") {
...
func TestTeardown(t *testing.T) {
	...
	if indexOfContains(r.Calls, "nft delete table inet wakeroute_pbr") < 0 {
...
func TestDryRun(t *testing.T) {
	pl := vowifiPlan(t)
	d := pl.DryRun(Options{})
	if len(d) == 0 || !strings.Contains(d[0], "table inet wakeroute_pbr") {
