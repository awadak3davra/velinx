...
type KernelArtifacts struct {
	...
	DnsmasqConfig  string // /opt/etc/dnsmasq.d/30-wakeroute.conf
	...
	NetfilterHook  string // /opt/etc/ndm/netfilter.d/40-wakeroute.sh
...
func kernelNetfilterHook(art *KernelArtifacts, io pbr.IpsetOptions) string {
	...
	b.WriteString("# WakeRoute kernel-PBR — re-assert ipset/iptables/ip after NDM netfilter rebuild.\n")
