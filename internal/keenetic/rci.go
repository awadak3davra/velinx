...
// tree) — the foundation of WakeRoute's native-first Keenetic backend. The backend uses
...
// CALLER OWNS SAFETY: only WakeRoute-managed config should be passed; never run with the
