...
// ImportKeenPBR converts a keen-pbr config.json into WakeRoute RoutingLists, preserving the
...
// (keen-pbr outbound tag → WakeRoute group/endpoint id). `files` supplies the lines of any
