...
func TestExtractConfigVlessKeepsEmbeddedEquals(t *testing.T) {
	link := "vless://u@1.2.3.4:443?security=reality&sni=www.microsoft.com&pbk=ABC=&sid=ff00#wakeroute-server"
...
func TestOneLinerPasswordBranchShape(t *testing.T) {
	...
	for _, want := range []string{"-p 2200", "ada@srv", "wakeroute-install.sh", "sshpass"} {
